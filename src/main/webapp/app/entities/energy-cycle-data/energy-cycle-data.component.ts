...
export class EnergyCycleDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyCycleDataService
            ...
            .subscribe(
                (res: HttpResponse<IEnergyCycleData[]>) => this.paginateEnergyCycleData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-cycle-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateEnergyCycleData(data: IEnergyCycleData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyCycleData = data;
    }
