...
export class EnergyVehicleModelDataUpdateComponent implements OnInit {
    ...
    brands: IEnergyVehicleBrandData[];
    ...
    ngOnInit() {
        ...
        this.energyVehicleBrandDataService.query({ filter: 'energyvehiclemodeldata-is-null' }).subscribe(
            (res: HttpResponse<IEnergyVehicleBrandData[]>) => {
                if (!this.energyVehicleModelData.brandId) {
                    this.brands = res.body;
                } else {
                    this.energyVehicleBrandDataService.find(this.energyVehicleModelData.brandId).subscribe(
                        (subRes: HttpResponse<IEnergyVehicleBrandData>) => {
                            this.brands = [subRes.body].concat(res.body);
                        },
