...
export class EnergyContractedPowerRatingDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyContractedPowerRatingDataService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IEnergyContractedPowerRatingData[]>) =>
                    this.paginateEnergyContractedPowerRatingData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-contracted-power-rating-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        ...
        this.router.navigate([
            '/energy-contracted-power-rating-data',
            {
                page: this.page,
                sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
            }
    ...
    private paginateEnergyContractedPowerRatingData(data: IEnergyContractedPowerRatingData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyContractedPowerRatingData = data;
    }
