...
export class EnergyVoltageDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyVoltageDataService
            ...
            .subscribe(
                (res: HttpResponse<IEnergyVoltageData[]>) => this.paginateEnergyVoltageData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-voltage-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateEnergyVoltageData(data: IEnergyVoltageData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyVoltageData = data;
    }
