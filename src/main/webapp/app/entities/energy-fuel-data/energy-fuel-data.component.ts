...
export class EnergyFuelDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyFuelDataService
            ...
            .subscribe(
                (res: HttpResponse<IEnergyFuelData[]>) => this.paginateEnergyFuelData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-fuel-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateEnergyFuelData(data: IEnergyFuelData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyFuelData = data;
    }
