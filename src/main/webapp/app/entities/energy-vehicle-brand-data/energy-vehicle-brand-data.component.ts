...
export class EnergyVehicleBrandDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyVehicleBrandDataService
            .query({
                page: this.page - 1,
            ...
            .subscribe(
                (res: HttpResponse<IEnergyVehicleBrandData[]>) => this.paginateEnergyVehicleBrandData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-vehicle-brand-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateEnergyVehicleBrandData(data: IEnergyVehicleBrandData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyVehicleBrandData = data;
    }
