...
export class EnergyTariffDataComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.energyTariffDataService
            ...
            .subscribe(
                (res: HttpResponse<IEnergyTariffData[]>) => this.paginateEnergyTariffData(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/energy-tariff-data'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateEnergyTariffData(data: IEnergyTariffData[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.energyTariffData = data;
    }
