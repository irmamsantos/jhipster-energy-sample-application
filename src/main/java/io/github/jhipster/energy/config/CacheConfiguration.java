...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.energy.domain.EnergyCycleData.class.getName() + ".energyElectricityData", jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyVoltageData.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyVoltageData.class.getName() + ".energyElectricityData", jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyTariffData.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyTariffData.class.getName() + ".energyElectricityData", jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyTimePeriodData.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.jhipster.energy.domain.EnergyTimePeriodData.class.getName() + ".energyElectricityData", jcacheConfiguration);
            ...
            cm.createCache(io.github.jhipster.energy.domain.EnergyVehicleModelData.class.getName() + ".energyVehicleBrandData", jcacheConfiguration);
