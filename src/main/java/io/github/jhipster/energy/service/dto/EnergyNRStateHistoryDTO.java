...
public class EnergyNRStateHistoryDTO implements Serializable {
    ...
    public Long getNeedNGRequestId() {
        return needNGRequestId;
    }

    public void setNeedNGRequestId(Long energyNeedNGRequestId) {
        this.needNGRequestId = energyNeedNGRequestId;
    }
    ...
    public String toString() {
        return "EnergyNRStateHistoryDTO{" +
            ...
            ", needNGRequest=" + getNeedNGRequestId() +
            ", user=" + getUserId() +
            "}";
    }
}
