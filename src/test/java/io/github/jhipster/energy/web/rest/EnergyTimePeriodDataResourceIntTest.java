...
public class EnergyTimePeriodDataResourceIntTest {
    ...
    @Autowired
    private EnergyTimePeriodDataMapper energyTimePeriodDataMapper;
    ...
    public void setup() {
        ...
        final EnergyTimePeriodDataResource energyTimePeriodDataResource = new EnergyTimePeriodDataResource(energyTimePeriodDataService);
    ...
    public void createEnergyTimePeriodData() throws Exception {
        ...
        EnergyTimePeriodDataDTO energyTimePeriodDataDTO = energyTimePeriodDataMapper.toDto(energyTimePeriodData);
        restEnergyTimePeriodDataMockMvc.perform(post("/api/energy-time-period-data")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(energyTimePeriodDataDTO)))
    ...
    public void updateEnergyTimePeriodData() throws Exception {
        ...
        EnergyTimePeriodDataDTO energyTimePeriodDataDTO = energyTimePeriodDataMapper.toDto(updatedEnergyTimePeriodData);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EnergyTimePeriodDataDTO.class);
        EnergyTimePeriodDataDTO energyTimePeriodDataDTO1 = new EnergyTimePeriodDataDTO();
        energyTimePeriodDataDTO1.setId(1L);
        EnergyTimePeriodDataDTO energyTimePeriodDataDTO2 = new EnergyTimePeriodDataDTO();
        assertThat(energyTimePeriodDataDTO1).isNotEqualTo(energyTimePeriodDataDTO2);
        energyTimePeriodDataDTO2.setId(energyTimePeriodDataDTO1.getId());
        assertThat(energyTimePeriodDataDTO1).isEqualTo(energyTimePeriodDataDTO2);
        energyTimePeriodDataDTO2.setId(2L);
        assertThat(energyTimePeriodDataDTO1).isNotEqualTo(energyTimePeriodDataDTO2);
        energyTimePeriodDataDTO1.setId(null);
        assertThat(energyTimePeriodDataDTO1).isNotEqualTo(energyTimePeriodDataDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(energyTimePeriodDataMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(energyTimePeriodDataMapper.fromId(null)).isNull();
    }
}
