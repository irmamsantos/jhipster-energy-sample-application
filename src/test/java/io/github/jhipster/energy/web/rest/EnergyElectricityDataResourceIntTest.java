...
public class EnergyElectricityDataResourceIntTest {
    ...
    @Autowired
    private EnergyElectricityDataMapper energyElectricityDataMapper;
    ...
    public void setup() {
        ...
        final EnergyElectricityDataResource energyElectricityDataResource = new EnergyElectricityDataResource(energyElectricityDataService);
    ...
    public void createEnergyElectricityData() throws Exception {
        ...
        EnergyElectricityDataDTO energyElectricityDataDTO = energyElectricityDataMapper.toDto(energyElectricityData);
        restEnergyElectricityDataMockMvc.perform(post("/api/energy-electricity-data")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(energyElectricityDataDTO)))
    ...
    public void updateEnergyElectricityData() throws Exception {
        ...
        EnergyElectricityDataDTO energyElectricityDataDTO = energyElectricityDataMapper.toDto(updatedEnergyElectricityData);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EnergyElectricityDataDTO.class);
        EnergyElectricityDataDTO energyElectricityDataDTO1 = new EnergyElectricityDataDTO();
        energyElectricityDataDTO1.setId(1L);
        EnergyElectricityDataDTO energyElectricityDataDTO2 = new EnergyElectricityDataDTO();
        assertThat(energyElectricityDataDTO1).isNotEqualTo(energyElectricityDataDTO2);
        energyElectricityDataDTO2.setId(energyElectricityDataDTO1.getId());
        assertThat(energyElectricityDataDTO1).isEqualTo(energyElectricityDataDTO2);
        energyElectricityDataDTO2.setId(2L);
        assertThat(energyElectricityDataDTO1).isNotEqualTo(energyElectricityDataDTO2);
        energyElectricityDataDTO1.setId(null);
        assertThat(energyElectricityDataDTO1).isNotEqualTo(energyElectricityDataDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(energyElectricityDataMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(energyElectricityDataMapper.fromId(null)).isNull();
    }
}
