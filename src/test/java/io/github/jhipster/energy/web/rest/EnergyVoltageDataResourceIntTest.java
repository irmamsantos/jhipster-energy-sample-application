...
public class EnergyVoltageDataResourceIntTest {
    ...
    @Autowired
    private EnergyVoltageDataMapper energyVoltageDataMapper;
    ...
    public void setup() {
        ...
        final EnergyVoltageDataResource energyVoltageDataResource = new EnergyVoltageDataResource(energyVoltageDataService);
    ...
    public void createEnergyVoltageData() throws Exception {
        ...
        EnergyVoltageDataDTO energyVoltageDataDTO = energyVoltageDataMapper.toDto(energyVoltageData);
        restEnergyVoltageDataMockMvc.perform(post("/api/energy-voltage-data")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(energyVoltageDataDTO)))
    ...
    public void updateEnergyVoltageData() throws Exception {
        ...
        EnergyVoltageDataDTO energyVoltageDataDTO = energyVoltageDataMapper.toDto(updatedEnergyVoltageData);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EnergyVoltageDataDTO.class);
        EnergyVoltageDataDTO energyVoltageDataDTO1 = new EnergyVoltageDataDTO();
        energyVoltageDataDTO1.setId(1L);
        EnergyVoltageDataDTO energyVoltageDataDTO2 = new EnergyVoltageDataDTO();
        assertThat(energyVoltageDataDTO1).isNotEqualTo(energyVoltageDataDTO2);
        energyVoltageDataDTO2.setId(energyVoltageDataDTO1.getId());
        assertThat(energyVoltageDataDTO1).isEqualTo(energyVoltageDataDTO2);
        energyVoltageDataDTO2.setId(2L);
        assertThat(energyVoltageDataDTO1).isNotEqualTo(energyVoltageDataDTO2);
        energyVoltageDataDTO1.setId(null);
        assertThat(energyVoltageDataDTO1).isNotEqualTo(energyVoltageDataDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(energyVoltageDataMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(energyVoltageDataMapper.fromId(null)).isNull();
    }
}
