...
public class EnergyVehicleModelDataResourceIntTest {
    ...
    @Autowired
    private EnergyVehicleModelDataMapper energyVehicleModelDataMapper;
    ...
    public void setup() {
        ...
        final EnergyVehicleModelDataResource energyVehicleModelDataResource = new EnergyVehicleModelDataResource(energyVehicleModelDataService);
    ...
    public void createEnergyVehicleModelData() throws Exception {
        ...
        EnergyVehicleModelDataDTO energyVehicleModelDataDTO = energyVehicleModelDataMapper.toDto(energyVehicleModelData);
        restEnergyVehicleModelDataMockMvc.perform(post("/api/energy-vehicle-model-data")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(energyVehicleModelDataDTO)))
    ...
    public void updateEnergyVehicleModelData() throws Exception {
        ...
        EnergyVehicleModelDataDTO energyVehicleModelDataDTO = energyVehicleModelDataMapper.toDto(updatedEnergyVehicleModelData);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EnergyVehicleModelDataDTO.class);
        EnergyVehicleModelDataDTO energyVehicleModelDataDTO1 = new EnergyVehicleModelDataDTO();
        energyVehicleModelDataDTO1.setId(1L);
        EnergyVehicleModelDataDTO energyVehicleModelDataDTO2 = new EnergyVehicleModelDataDTO();
        assertThat(energyVehicleModelDataDTO1).isNotEqualTo(energyVehicleModelDataDTO2);
        energyVehicleModelDataDTO2.setId(energyVehicleModelDataDTO1.getId());
        assertThat(energyVehicleModelDataDTO1).isEqualTo(energyVehicleModelDataDTO2);
        energyVehicleModelDataDTO2.setId(2L);
        assertThat(energyVehicleModelDataDTO1).isNotEqualTo(energyVehicleModelDataDTO2);
        energyVehicleModelDataDTO1.setId(null);
        assertThat(energyVehicleModelDataDTO1).isNotEqualTo(energyVehicleModelDataDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(energyVehicleModelDataMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(energyVehicleModelDataMapper.fromId(null)).isNull();
    }
}
