...
public class EnergyNaturalGasDataResourceIntTest {
    ...
    @Autowired
    private EnergyNaturalGasDataMapper energyNaturalGasDataMapper;
    ...
    public void setup() {
        ...
        final EnergyNaturalGasDataResource energyNaturalGasDataResource = new EnergyNaturalGasDataResource(energyNaturalGasDataService);
    ...
    public void createEnergyNaturalGasData() throws Exception {
        ...
        EnergyNaturalGasDataDTO energyNaturalGasDataDTO = energyNaturalGasDataMapper.toDto(energyNaturalGasData);
        restEnergyNaturalGasDataMockMvc.perform(post("/api/energy-natural-gas-data")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(energyNaturalGasDataDTO)))
    ...
    public void updateEnergyNaturalGasData() throws Exception {
        ...
        EnergyNaturalGasDataDTO energyNaturalGasDataDTO = energyNaturalGasDataMapper.toDto(updatedEnergyNaturalGasData);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EnergyNaturalGasDataDTO.class);
        EnergyNaturalGasDataDTO energyNaturalGasDataDTO1 = new EnergyNaturalGasDataDTO();
        energyNaturalGasDataDTO1.setId(1L);
        EnergyNaturalGasDataDTO energyNaturalGasDataDTO2 = new EnergyNaturalGasDataDTO();
        assertThat(energyNaturalGasDataDTO1).isNotEqualTo(energyNaturalGasDataDTO2);
        energyNaturalGasDataDTO2.setId(energyNaturalGasDataDTO1.getId());
        assertThat(energyNaturalGasDataDTO1).isEqualTo(energyNaturalGasDataDTO2);
        energyNaturalGasDataDTO2.setId(2L);
        assertThat(energyNaturalGasDataDTO1).isNotEqualTo(energyNaturalGasDataDTO2);
        energyNaturalGasDataDTO1.setId(null);
        assertThat(energyNaturalGasDataDTO1).isNotEqualTo(energyNaturalGasDataDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(energyNaturalGasDataMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(energyNaturalGasDataMapper.fromId(null)).isNull();
    }
}
