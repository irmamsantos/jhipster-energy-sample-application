...
export default class BlogEntryUpdatePage {
  pageTitle: ElementFinder = element(by.id('blogApp.blogEntry.home.createOrEditLabel'));
  ...
  blogSelect: ElementFinder = element(by.css('select#blog-entry-blog'));
  tagSelect: ElementFinder = element(by.css('select#blog-entry-tag'));
