...
export class EnergyNRStateHistoryUpdatePage {
    ...
    needNGRequestSelect = element(by.id('field_needNGRequest'));
    ...
    async needNGRequestSelectLastOption() {
        await this.needNGRequestSelect
            .all(by.tagName('option'))
            .last()
            .click();
    }

    async needNGRequestSelectOption(option) {
        await this.needNGRequestSelect.sendKeys(option);
    }

    getNeedNGRequestSelect(): ElementFinder {
        return this.needNGRequestSelect;
    }

    async getNeedNGRequestSelectedOption() {
        return this.needNGRequestSelect.element(by.css('option:checked')).getText();
    }
