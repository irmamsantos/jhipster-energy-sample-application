...
describe('EnergyElectricityData e2e test', () => {
    ...
    it('should create and save EnergyElectricityData', async () => {
        ...
        await energyElectricityDataComponentsPage.clickOnCreateButton();
        await promise.all([
            energyElectricityDataUpdatePage.voltageSelectLastOption(),
            energyElectricityDataUpdatePage.tariffSelectLastOption(),
            energyElectricityDataUpdatePage.cycleSelectLastOption(),
            energyElectricityDataUpdatePage.timePeriodSelectLastOption()
        ]);
